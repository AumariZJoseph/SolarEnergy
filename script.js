...
function startSlideshow() {
    ...
    // Change slide every 5 seconds (4 seconds on mobile for better engagement)
...
if (slides.length > 0) {
    ...
    // Restart slideshow on window resize (to adjust timing for mobile/desktop)
    let resizeTimer;
    ...
    // Ensure slideshow restarts when scrolling back into view (fallback)
    let scrollTimer;
